					...
					<div class="row">
						<div class="col-lg-12">
							<div class="error-content text-center">
								...
								<a class="button-one submit-btn-4 go-to-home bg-white text-uppercase text-light-black" href="../index.php" data-text="go to home page" >go to home page</a>
							</div>
						</div>
					</div>
				</div>
