        ...
        <div class="col-md-12">
          <form class="" action="edit.php" method="post">
           <div class="form-group form-row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="published_date" id="published_date" value="<?php echo $news['published_date']; ?>"> </div>
            </div>
            <div class="form-group form-row">
              <label class="col-sm-2 col-form-label">標題</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="title" value="<?php echo $news['title']; ?>"> </div>
            </div>
            <div class="form-group form-row">
              <label class="col-sm-2 col-form-label">消息內容</label>
              <div class="col-sm-10">
                <textarea row="8" class="form-control" name="content"><?php echo $news['content']; ?></textarea>
              </div>
            </div>
