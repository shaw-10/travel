...
<?php include_once('../layouts/nav.php'); ?>
      ...
      <div class="row">
        ...
        <form action="#" method="get">
          <select class="form-control" name="status" id="status">
            <option value="888"<?php if($_GET['status'] == 888) echo "selected"; ?> >全部訂單</option>
            <option value="0" <?php if($_GET['status'] == 0) echo "selected"; ?>>新訂單</option>
            <option value="1" <?php if($_GET['status'] == 1) echo "selected"; ?>>已付款訂單</option>
            <option value="2" <?php if( $_GET['status'] == 2) echo "selected"; ?>>已出貨訂單</option>
            <option value="3" <?php if($_GET['status'] == 3) echo "selected"; ?>>交易完成訂單</option>
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="../order_details/list.php?customer_orderID=<?php echo $customer_orders['customer_orderID']; ?>" class="btn btn-outline-primary">檢視訂單明細</a>
                  <a href="edit.php?customer_orderID=<?php echo $customer_orders['customer_orderID']; ?>" class="btn btn-primary">編輯</a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
  ...
  <script>
    ...
    $(function(){
        $('select[name="status"]').change(function(){ //ID 為 submitExample 的按鈕被點擊時
